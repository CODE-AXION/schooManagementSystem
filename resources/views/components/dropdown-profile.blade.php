...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    >
        ...
        <div class="flex items-center truncate">
            <span class="truncate ml-2 text-sm font-medium dark:text-slate-300 group-hover:text-slate-800 dark:group-hover:text-slate-200"></span>
    ...
    >
        <div class="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200 dark:border-slate-700">
            ...
            <div class="text-xs text-slate-500 dark:text-slate-400 italic">{{Auth::user()->name}}</div>
        </div>
        <ul>
            <li>
                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3" href="" @click="open = false" @focus="open = true" @focusout="open = false">Settings</a>
            </li>
            <li>
